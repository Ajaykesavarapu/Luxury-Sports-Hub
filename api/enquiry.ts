...
export default function handler(req: VercelRequest, res: VercelResponse) {
  ...
  try {
    ...
    console.log('[ENQUIRY]', JSON.stringify({ name, email, phone, sport, enquiryType, message, preferredTiming, attendanceType, numberOfAttendees, friendReferral, referralMobile, referralEmail, timestamp: new Date().toISOString() }));
